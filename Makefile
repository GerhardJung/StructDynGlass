...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mon Dec 13 10:10:02 2021
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/StructDynGlass1.0.0/ && $(COPY_FILE) --parents defs.h dyn_bb.h eval_isoconf.h nrutil.h pbc.h read_write_lammps.h .tmp/StructDynGlass1.0.0/ && $(COPY_FILE) --parents defs.cpp dyn_bb.cpp eval_isoconf.cpp main.cpp nrutil.cpp pbc.cpp read_write_lammps.cpp .tmp/StructDynGlass1.0.0/ && (cd `dirname .tmp/StructDynGlass1.0.0` && $(TAR) StructDynGlass1.0.0.tar StructDynGlass1.0.0 && $(COMPRESS) StructDynGlass1.0.0.tar) && $(MOVE) `dirname .tmp/StructDynGlass1.0.0`/StructDynGlass1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/StructDynGlass1.0.0
