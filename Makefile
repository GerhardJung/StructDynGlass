...
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar. janv. 11 14:33:28 2022
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/StructDynGlass1.0.0/ && $(COPY_FILE) --parents defs.h dyn_bb.h dyn_exp.h dyn_isf.h dyn_msd.h eval_isoconf.h global.h nrutil.h pbc.h read_write_lammps.h struct_base.h struct_soft_modes.h .tmp/StructDynGlass1.0.0/ && $(COPY_FILE) --parents defs.cpp dyn_bb.cpp dyn_exp.cpp dyn_isf.cpp dyn_msd.cpp dyn_rearrange_patinet.cpp eval_isoconf.cpp global.cpp main.cpp nrutil.cpp pbc.cpp read_write_lammps.cpp struct_base.cpp struct_soft_modes.cpp .tmp/StructDynGlass1.0.0/ && (cd `dirname .tmp/StructDynGlass1.0.0` && $(TAR) StructDynGlass1.0.0.tar StructDynGlass1.0.0 && $(COMPRESS) StructDynGlass1.0.0.tar) && $(MOVE) `dirname .tmp/StructDynGlass1.0.0`/StructDynGlass1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/StructDynGlass1.0.0
...
dyn_rearrange_patinet.o: dyn_rearrange_patinet.cpp global.h \
		defs.h \
		nrutil.h \
		read_write_lammps.h \
		pbc.h \
