		...
		for m in mode_array:
			for d in dyn_array:
				...
				for t in range(Tstart, Tstop):
					...
					KA2D_model = load_model("./models_mlp/mlpparams_free_{}{}{}_{}_{}.dat".format(m, d,t, Type,cg), custom_objects={'custom_loss': custom_loss, 'pearson_loss': pearson_loss})
